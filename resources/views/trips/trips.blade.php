                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form
                                ...
                                <button type="button" onclick="addTripService()" class="btn btn-outline-primary mt-2">Add Service</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="trip[fleet_id]" class="form-control" id="driverFleets">
                                                <option selected disabled>Select Option</option>
                                                @foreach ($fleets as $t)
                                                    <option value="{{ $t->id }}">{{ $t->make_model }} | {{ $t->reg_no }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="trip[instructions]" id="" class="form-control" placeholder="Instructions" cols="20" rows="2"></textarea>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 80vh;">
                    ...
                    <iframe src="http://localhost/tests/maps/" id="myIframe" style="border:none;height: 100%;width:100%;" frameborder="0"></iframe>
                </div><!--end modal-body-->
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
                    <button type="button" onclick="getIframeData()" data-bs-dismiss="modal" class="btn btn-primary btn-sm">Save changes</button>
