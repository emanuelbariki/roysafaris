        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ isset($fleettype) ? route('fleettypes.update', $fleettype->id) : route('fleettypes.store') }}" method="POST">
                            @csrf
                            @if (isset($fleettype))
                                @method('PUT')
                            @endif
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="fleettype[name]" placeholder="Transfer,Safari,VIP,etc." required="" value="{{ isset($fleettype) ? $fleettype->name : old('name') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="useremail">Status</label>
                                        <select name="fleettype[status]" class="form-control">
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel11">
                                                        <a class="dropdown-item" href="{{ route('fleettypes.index', ['edit' => $f->id]) }}">Edit</a>
                                                        <a class="dropdown-item text-danger" href="{{ route('fleettypes.index', ['edit' => $f->id]) }}">Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
