        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form {{ isset($channel) ? route('channels.update', $channel->id) : route('channels.store') }}"
                            method="POST">
                            @csrf
                            @if (isset($channel))
                                @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="channel[name]" placeholder="Online, Direct-Email, etc" required="" value="{{ isset($channel) ? $channel->name : old('name') }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="channel[status]" class="form-control">
