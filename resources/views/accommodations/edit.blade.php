                        ...
                        <div class="row">
                                    ...
                                    <select name="accommodation[hotel_chain_id]" class="form-control" required>
                                        ...
                                        @foreach ($hotelChains as $hotel)
                                            <option value="{{ $hotel->id }}"
                                                {{ (isset($accommodation) && $accommodation->hotel_chain_id == $hotel->id) || old('hotel_chain_id') == $hotel->id ? 'selected' : '' }}>
                                                {{ $hotel->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="accommodation[accommodations_type_id]" class="form-control" required>
                                        ...
                                        @foreach ($accommodationTypes as $type)
                                            <option value="{{ $type->id }}"
                                                {{ (isset($accommodation) && $accommodation->accommodations_type_id == $type->id) || old('accommodations_type_id') == $type->id ? 'selected' : '' }}>
                                                {{ $type->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="accommodation[country]" class="form-control" required>
                                        <option value="">Choose Country</option>
                                        @foreach(Country::cases() as $country)
                                            <option value="{{ $country->value }}"
                                                {{ (isset($accommodation) && $accommodation->country === $country->value) || old('country') === $country->value ? 'selected' : '' }}>
                                                {{ $country->value }}
                                            </option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="bank_name" class="form-control">
                                        ...
                                        @foreach(Bank::cases() as $bank)
                                            <option value="{{ $bank->value }}"
                                                {{ (isset($accommodation) && $accommodation->bank_name === $bank->value) || old('bank_name') === $bank->value ? 'selected' : '' }}>
                                                {{ $bank->value }}
                                            </option>
                                        @endforeach
                                    </select>
