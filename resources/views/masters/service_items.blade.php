        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ isset($serviceitem) ? route('serviceitems.update', $serviceitem->id) : route('serviceitems.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="serviceitem[name]" placeholder="Lunch Boxes, Water, etc." required="" value="{{ isset($serviceitem) ? $serviceitem->name : old('name') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name">Service Category</label>
                                        <select name="serviceitem[category]" class="form-control">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="serviceitem[status]" class="form-control">
                                            <option selected disabled>Choose</option>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered mb-0 table-centered table-hover">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($serviceitems as $index => $f )
                                        <tr>
                                            <td>{{ $index+1 }}</td>
                                            <td>{{ $f->name }}</td>
                                            <td>{{ $f->category }}</td>
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel11">
                                                        <a class="dropdown-item" href="{{ route('serviceitems.index', ['edit' => $f->id]) }}">Edit</a>
