            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('roles.store') }}">
                        ...
                        <h4>Permissions</h4>
                        <p class="text-muted">Select permissions for this role. You can select individual
                            permissions or entire modules.</p>
                        ...
                        @if($modules->count() === 0)
                            <div class="alert alert-warning">
                                ...
                                <a href="{{ route('permissions.create') }}" class="alert-link">Create
                                    Permissions</a>
                            </div>
                        @endif
