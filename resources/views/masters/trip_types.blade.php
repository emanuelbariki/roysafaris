        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ isset($triptype) ? route('triptypes.update', $triptype->id) : route('triptypes.store') }}"
                            method="POST">
                            @csrf
                            @if (isset($triptype))
                                @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="triptype[name]" placeholder="Transfer,Safari,LargeGroups,VIP,etc." required="" value="{{ isset($triptype) ? $triptype->name : old('name') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="useremail">Status</label>
                                        <select name="triptype[status]" class="form-control">
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown d-inline-block">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dLabel11">
                                                    <a class="dropdown-item" href="{{ route('triptypes.index', ['edit' => $f->id]) }}">Edit</a>
